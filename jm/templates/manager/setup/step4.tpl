...
<div class="form-horizontal">
	...
	<div class="form-group">
		...
		<div class="col-sm-11">
			...
			<div>
				<div>
					<div class="col-sm-1"><input type="checkbox" name="showGalleyLinks" id="showGalleyLinks" {if $showGalleyLinks} checked="checked"{/if} /></div>
					<div class="col-sm-11"><label for="showGalleyLinks">{translate key="manager.setup.showGalleyLinksDescription"}</label></div>
				</div>
			</div>
		</div>
	</div>
...
<div class="form-horizontal">
	<div class="form-group">
		<div class="col-sm-1"><input type="checkbox" name="restrictSiteAccess" id="restrictSiteAccess" value="1"{if $restrictSiteAccess} checked="checked"{/if} /></div>
		<div class="col-sm-11"><label for="restrictSiteAccess">{translate key="manager.setup.restrictSiteAccess"}</label></div>
	</div>
	<div class="form-group">
		<div class="col-sm-1"><input type="checkbox" name="restrictArticleAccess" id="restrictArticleAccess" value="1"{if $restrictArticleAccess} checked="checked"{/if} /></div>
		<div class="col-sm-11"><label for="restrictArticleAccess">{translate key="manager.setup.restrictArticleAccess"}</label></div>
	</div>
</div>
</div><!-- siteAccess -->
...
<div class="horizontal">
	<div class="form-group">
		<div class="col-sm-1"><input type="radio" name="disableUserReg" id="disableUserReg-0" value="0" onclick="setRegAllowOpts(this.form)"{if !$disableUserReg} checked="checked"{/if} /></div>
		<div class="col-sm-11">
			<label for="disableUserReg-0">{translate key="manager.setup.enableUserRegistration"}</label>
			<div>
				<div>
					<div class="col-sm-1"><input type="checkbox" name="allowRegReader" id="allowRegReader" value="1"{if $allowRegReader} checked="checked"{/if}{if $disableUserReg} disabled="disabled"{/if} /></div>
					<div class="col-sm-11"><label for="allowRegReader">{translate key="manager.setup.enableUserRegistration.reader"}</label></div>
				</div>
				<div>
					<div class="col-sm-1"><input type="checkbox" name="allowRegAuthor" id="allowRegAuthor" value="1"{if $allowRegAuthor} checked="checked"{/if}{if $disableUserReg} disabled="disabled"{/if} /></div>
					<div class="col-sm-11"><label for="allowRegAuthor">{translate key="manager.setup.enableUserRegistration.author"}</label></div>
				</div>
				<div>
					<div class="col-sm-1"><input type="checkbox" name="allowRegReviewer" id="allowRegReviewer" value="1"{if $allowRegReviewer} checked="checked"{/if}{if $disableUserReg} disabled="disabled"{/if} /></div>
					<div class="col-sm-11"><label for="allowRegReviewer">{translate key="manager.setup.enableUserRegistration.reviewer"}</label></div>
				</div>
			</div>
		</div>
	</div>
	<div class="form-group">
		<div class="col-sm-1"><input type="radio" name="disableUserReg" id="disableUserReg-1" value="1" onclick="setRegAllowOpts(this.form)"{if $disableUserReg} checked="checked"{/if} /></div>
		<div class="col-sm-11"><label for="disableUserReg-1">{translate key="manager.setup.disableUserRegistration"}</label></div>
	</div>
</div>
...
<div class="form-horizontal">
	<div>
		<div class="col-sm-1"><input type="checkbox" name="publicationFormatVolume" id="publicationFormatVolume" value="1"{if ($publicationFormatVolume)} checked="checked"{/if} /></div>
		<div><label for="publicationFormatVolume">{translate key="manager.setup.publicationFormatVolume"}</label></div>
	</div>
	<div>
		<div class="col-sm-1"><input type="checkbox" name="publicationFormatNumber" id="publicationFormatNumber" value="1"{if ($publicationFormatNumber)} checked="checked"{/if} /></div>
		<div><label for="publicationFormatNumber">{translate key="manager.setup.publicationFormatNumber"}</label></div>
	</div>
	<div>
		<div class="col-sm-1"><input type="checkbox" name="publicationFormatYear" id="publicationFormatYear" value="1"{if ($publicationFormatYear)} checked="checked"{/if} /></div>
		<div><label for="publicationFormatYear">{translate key="manager.setup.publicationFormatYear"}</label></div>
	</div>
	<div>
		<div class="col-sm-1"><input type="checkbox" name="publicationFormatTitle" id="publicationFormatTitle" value="1"{if ($publicationFormatTitle)} checked="checked"{/if} /></div>
		<div>
...
<div class="form-horizontal">
	<div class="form-group">
		{fieldLabel name="initialNumber" key="issue.number" class="col-sm-2 control-label"}
	...
	<div class="form-group">
		{fieldLabel name="initialVolume" key="issue.volume" class="col-sm-2 control-label"}
	...
	<div class="form-group">
		{fieldLabel name="initialYear" key="issue.year" class="col-sm-2 control-label"}
	...
	<div class="form-group">
		{fieldLabel name="issuePerVolume" key="manager.setup.issuePerVolume" class="col-sm-2 control-label"}
	...
	<div class="form-group">
		{fieldLabel name="volumePerYear" key="manager.setup.volumePerYear" class="col-sm-2 control-label"}
...
<div class="form-horizontal">
	<div class="form-group">
		<div class="col-sm-1"><input type="checkbox" name="enablePublicIssueId" id="enablePublicIssueId" value="1"{if $enablePublicIssueId} checked="checked"{/if} /></div>
		<div class="col-sm-11"><label for="enablePublicIssueId">{translate key="manager.setup.enablePublicIssueId"}</label></div>
	</div>
	<div class="form-group">
		<div class="col-sm-1"><input type="checkbox" name="enablePublicArticleId" id="enablePublicArticleId" value="1"{if $enablePublicArticleId} checked="checked"{/if} /></div>
		<div class="col-sm-11"><label for="enablePublicArticleId">{translate key="manager.setup.enablePublicArticleId"}</label></div>
	</div>
	<div class="form-group">
		<div class="col-sm-1"><input type="checkbox" name="enablePublicGalleyId" id="enablePublicGalleyId" value="1"{if $enablePublicGalleyId} checked="checked"{/if} /></div>
		<div class="col-sm-11"><label for="enablePublicGalleyId">{translate key="manager.setup.enablePublicGalleyId"}</label></div>
	</div>
	<div class="form-group">
		<div class="col-sm-1"><input type="checkbox" name="enablePublicSuppFileId" id="enablePublicSuppFileId" value="1"{if $enablePublicSuppFileId} checked="checked"{/if} /></div>
		<div class="col-sm-11"><label for="enablePublicSuppFileId">{translate key="manager.setup.enablePublicSuppFileId"}</label></div>
	</div>
</div>
...
<div class="form-horizontal">
	<div class="form-group">
		<div class="col-sm-1"><input type="checkbox" name="enablePageNumber" id="enablePageNumber" value="1"{if $enablePageNumber} checked="checked"{/if} /></div>
		<div class="col-sm-11"><label for="enablePageNumber">{translate key="manager.setup.enablePageNumber"}</label></div>
	</div>
</div>
...
<p>
	<div class="data">
		<div class="col-sm-1"><input type="checkbox" name="enableAnnouncements" id="enableAnnouncements" value="1" {if $enableAnnouncements} checked="checked"{/if} /></div>
...
<p>
	<div class="data">
		<div class="col-sm-1"><input type="checkbox" name="enableAnnouncementsHomepage" id="enableAnnouncementsHomepage" value="1" onclick="toggleEnableAnnouncementsHomepage(this.form)"{if $enableAnnouncementsHomepage} checked="checked"{/if} /></div>
...
<div class="form-horizontal">
	<div class="form-group">
		<div class="col-sm-1"><input type="radio" name="useCopyeditors" id="useCopyeditors-1" value="1"{if $useCopyeditors} checked="checked"{/if} /></div>
		<div class="col-sm-11"><label for="useCopyeditors-1">{translate key="manager.setup.useCopyeditors"}</label></div>
	</div>
	<div class="form-group">
		<div class="col-sm-1"><input type="radio" name="useCopyeditors" id="useCopyeditors-0" value="0"{if !$useCopyeditors} checked="checked"{/if} /></div>
		<div class="col-sm-11"><label for="useCopyeditors-0">{translate key="manager.setup.noUseCopyeditors"}</label></div>
	</div>
</div>
</div><!-- copyediting -->
...
<div class="horizontal">
	<div class="form-group">
		<div class="col-sm-1"><input type="radio" name="useLayoutEditors" id="useLayoutEditors-1" value="1"{if $useLayoutEditors} checked="checked"{/if} /></div>
		<div class="col-sm-11"><label for="useLayoutEditors-1">{translate key="manager.setup.useLayoutEditors"}</label></div>
	</div>
	<div class="form-group">
		<div class="col-sm-1"><input type="radio" name="useLayoutEditors" id="useLayoutEditors-0" value="0"{if !$useLayoutEditors} checked="checked"{/if} /></div>
		<div class="col-sm-11"><label for="useLayoutEditors-0">{translate key="manager.setup.noUseLayoutEditors"}</label></div>
	</div>
</div>
...
{foreach name=templates from=$templates key=templateId item=template}
	<div class="form-group">
		<div width="20%" class="label"><a href="{url op="downloadLayoutTemplate" path=$templateId}" class="action">{$template.filename|escape}</a></div>
		<div width="50%" class="value">{$template.title|escape}</div>
		<div width="30%"><input type="submit" name="delTemplate[{$templateId|escape}]" value="{translate key="common.delete"}" class="btn btn-primary" /></div>
	</div>
...
{/foreach}
		...
		<div class="form-group">
			{fieldLabel name="template-title" key="manager.setup.layoutTemplates.title" class="col-sm-2 control-label"}
			<div class="col-sm-10"><input type="text" name="template-title" id="template-title" size="40" maxlength="90" class="form-control" /></div>
		</div>

	<div class="form-group">
		{fieldLabel name="template-file" key="manager.setup.layoutTemplates.file" class="col-sm-2 control-label"}
		<div class="col-sm-10"><input type="file" name="template-file" id="template-file" class="uploadField" /><input type="submit" name="addTemplate" value="{translate key="common.upload"}" class="btn btn-primary" /></div>
	</div>
</div>
</div><!-- layoutTemplates -->
...
<p><input type="submit" value="{translate key="common.saveAndContinue"}" class="btn btn-primary" /> <input type="button" value="{translate key="common.cancel"}" class="btn btn-primary btn-lg" onclick="document.location.href='{url op="setup" escape=false}'" /></p>
