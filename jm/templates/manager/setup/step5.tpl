...
<div width="100%" class="form-horizontal">
	<div class="form-group">
		{fieldLabel name="homeHeaderTitleImageAltText" key="common.altText" class="col-sm-2 control-label"}
...
<div class="form-horizontal">
	<div class="form-group">
		<div class="col-sm-2">{fieldLabel name="homeHeaderLogoImageAltText" key="common.altText" class="col-sm-2 control-label"}</div>
		<div class="col-sm-10"><input type="text" name="homeHeaderLogoImageAltText[{$formLocale|escape}]" value="{$homeHeaderLogoImageAltText[$formLocale]|escape}" size="40" maxlength="255" class="form-control" /></div>
	</div>
	<div>
...
<div class="form-horizontal">
	<div class="form-group">
		{fieldLabel name="journalThumbnailAltText" key="common.altText" class="col-sm-2 control-label"}
		<div class="col-sm-10"><input type="text" name="journalThumbnailAltText[{$formLocale|escape}]" value="{$journalThumbnailAltText[$formLocale]|escape}" size="40" maxlength="255" class="form-control" /></div>
	</div>
	<div>
		<div class="value"><span class="instruct">{translate key="common.altTextInstructions"}</span></div>
	</div>
...
<div width="100%" class="form-horizontal">
	<div class="form-group">
		<div class="col-sm-2 control-label">{translate key="manager.setup.homepageImage"}</div>
		<p><div class="col-sm-10"><input type="file" name="homepageImage" class="uploadField" /></p> <input type="submit" name="uploadHomepageImage" value="{translate key="common.upload"}" class="btn btn-primary" /></div>
	</div>
</div>
...
{foreach name=navItems from=$navItems[$formLocale] key=navItemId item=navItem}
	<div class="form-group">
		{fieldLabel name="navItems-$navItemId-name" key="manager.setup.labelName" class="col-sm-2"}
			<input type="text" name="navItems[{$formLocale|escape}][{$navItemId|escape}][name]" id="navItems-{$navItemId|escape}-name" value="{$navItem.name|escape}" size="30" maxlength="90" class="form-control" /> <input type="submit" name="delNavItem[{$navItemId|escape}]" value="{translate key="common.delete"}" class="btn btn-primary" />
			<div width="100%">
				<div class="top">
...
<div class="form-horizontal">
<div class="form-group">
	<div class="col-sm-2 control-label"><label for="journalTheme">{translate key="manager.setup.journalTheme"}</label></div>
		<div class="col-sm-10">
...
<div>
	<div class="col-sm-2 control-label"><label for="journalStyleSheet">{translate key="manager.setup.useJournalStyleSheet"}</label></div>
	<p><div class="col-sm-10"><input type="file" name="journalStyleSheet" id="journalStyleSheet" class="uploadField" /> </p><input type="submit" name="uploadJournalStyleSheet" value="{translate key="common.upload"}" class="btn btn-primary" /></div>
</div>
</div>
...
<table id="assignBlocksToSidebars" border="0" align="center" style="width: 100%;">
	<tr align="center">
		<td rowspan="2" id="assignBlocksToSidebarLeft" style="with: 30%;" >
			...
			<input class="btn btn-primary" style="width: 100%;" type="button" value="&uarr;" onclick="moveUp(this.form.elements['blockSelectLeftWidget']);" /><br/>
			...
			<input class="btn btn-primary" style="width: 100%;" type="button" value="&darr;" onclick="moveDown(this.form.elements['blockSelectLeftWidget']);" />
		</td>
		<td>
			<input class="btn btn-primary" style="width: 100%;" type="button" value="&larr;" onclick="jumpList(this.form.elements['blockUnselectedWidget'],this.form.elements['blockSelectLeftWidget']);" /><br/>
			<input class="btn btn-primary" style="width: 100%;" type="button" value="&rarr;" onclick="jumpList(this.form.elements['blockSelectLeftWidget'],this.form.elements['blockUnselectedWidget']);" />
		</td>
		...
		<td>
			<input class="btn btn-primary" style="width: 100%;" type="button" value="&larr;" onclick="jumpList(this.form.elements['blockSelectRightWidget'],this.form.elements['blockUnselectedWidget']);" /><br/>
			<input class="btn btn-primary" style="width: 100%;" type="button" value="&rarr;" onclick="jumpList(this.form.elements['blockUnselectedWidget'],this.form.elements['blockSelectRightWidget']);" />
		</td>
		<td rowspan="2" id="assignBlocksToSidebarRight" style="width: 30%;">
			{translate key="manager.setup.layout.rightSidebar"}<br/>
			<input class="btn btn-primary" style="width: 100%;" type="button" value="&uarr;" onclick="moveUp(this.form.elements['blockSelectRightWidget']);" /><br/>
			...
			<input class="btn btn-primary" style="width: 100%;" type="button" value="&darr;" onclick="moveDown(this.form.elements['blockSelectRightWidget']);" />
		</td>
	</tr>
	<tr align="center">
		<td colspan="3" valign="top" height="60px">
			<input class="btn btn-primary" style="width: 100%;" type="button" value="&larr;" onclick="jumpList(this.form.elements['blockSelectRightWidget'],this.form.elements['blockSelectLeftWidget']);" /><br/>
			<input class="btn btn-primary" style="width: 100%;" type="button" value="&rarr;" onclick="jumpList(this.form.elements['blockSelectLeftWidget'],this.form.elements['blockSelectRightWidget']);" />
		</td>
	</tr>
</table>
...
<div class="form-horizontal">
	<div class="form-group">
		<div class="col-sm-2 control-label">{translate key="manager.setup.itemsPerPage"}</div>
		<p><div class="col-sm-5"><input type="text" size="3" name="itemsPerPage" class="form-control" value="{$itemsPerPage|escape}" /></div>
	</div>
	<div class="form-group">
		<div class="col-sm-2 control-label">{translate key="manager.setup.numPageLinks"}</div>
		<p><div class="col-sm-5"><input type="text" size="3" name="numPageLinks" class="form-control" value="{$numPageLinks|escape}" /></div>
	</div>
</div>
...
<p><input type="submit" onclick="prepBlockFields()" value="{translate key="common.saveAndContinue"}" class="btn btn-primary" /> <input type="button" value="{translate key="common.cancel"}" class="btn btn-primary btn-lg" onclick="document.location.href='{url op="setup" escape=false}'" /></p>
